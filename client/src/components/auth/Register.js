                                    ...
                                    <div className="p-5">
                                        ...
                                        <form className="user">
                                            ...
                                            <div className="form-group row">
                                                ...
                                                <div className="col-sm-6">
                                                    <input type="password" className="form-control" id="exampleRepeatPassword" placeholder="Confirm password" />
                                                </div>
                                            </div>
                                        ...
                                        <div className="text-center">
                                            <Link className="small" to="/login">Already have an account?</Link>
                                        </div>
                                        <div className="text-center">
                                            <Link className="small" to="/">Learn more</Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
